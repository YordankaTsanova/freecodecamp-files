...
--
-- Name: properties fk_property_type; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_property_type FOREIGN KEY (type_id) REFERENCES public.types(type_id);
